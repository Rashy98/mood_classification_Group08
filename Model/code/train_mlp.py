...
if __name__ == '__main__':
    ...
    parser.add_argument('--best_model_path', default='mlp_arousal.pth')
    ...
    all_x = np.load('./data/spotify/combined_features_normalized.npy')
    print(args.emo_dim)
    print(all_x.shape)
  ...
  #  df.to_csv('fuse_spect_'+args.emo_dim+'_test.csv',index = False)
   ...
   # df.to_csv('fuse_spect_'+args.emo_dim+'valid.csv',index = False)
    ...
    print(preds)
    print('valid: ',tracc,'valid: ',acc,' test: ',tacc)
