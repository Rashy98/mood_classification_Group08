...
if __name__ == '__main__':
    ...
    if args.emo_dim=='arousal':
        model.load_state_dict(torch.load('./pretrained/rnn_arousal.pth'),strict = False)
    else:
        model.load_state_dict(torch.load('./pretrained/rnn_valence.pth'),strict = False)
