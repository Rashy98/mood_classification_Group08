...
if __name__ == '__main__':
    ...
    parser.add_argument('--epoch_num', default=10, help='number of train epochs')
    parser.add_argument('--device', default='cuda', help='cuda device')
    parser.add_argument('--learning_rate', default=7e-4, help='learning rate')
    parser.add_argument('--best_model_path', default='cnn_arousal.pth')
    ...
    all_x = np.load('./data/spect_cut.npy')/255
    all_x = np.transpose(all_x, (0,3, 1, 2))
    print(args.emo_dim)
    ...
    if args.emo_dim=='arousal':
        model.load_state_dict(torch.load('./pretrained/cnn_arousal.pth'))
    else:
